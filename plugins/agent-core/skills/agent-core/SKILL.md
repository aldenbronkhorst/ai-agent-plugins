...
- Before reporting that access is unavailable or asking the user for credentials, inspect the available tools and skills for an applicable password-manager or credential-provider capability and use it when available.
